      ...
      {(status === 'a_pagar' || status === 'lembrete') && (
        <>
          ...
          <button
            ...
            className="w-auto flex items-center justify-center gap-2 bg-error text-white py-3.5 px-5 rounded-xl text-label-md hover:bg-error/90 transition-colors shadow-sm"
          >
          ...
          <button
            ...
            className="w-auto flex items-center justify-center gap-2 bg-gray-200 text-gray-700 py-3.5 px-5 rounded-xl text-label-md hover:bg-gray-300 transition-colors"
          >
